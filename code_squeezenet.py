...
WEIGHTS_PATH = 'https://github.com/wohlert/keras-squeezenet/releases/download/v0.1/squeezenet_weights.h5' #pretrained weights for SqueezeNet
...
def SqueezeNet_Tune(include_top=True, weights="imagenet", input_tensor=None, input_shape=None, pooling=None, classes=1000):
    ...
    x = Dense(512, activation='relu', name = 'top_dense_1')(x)
